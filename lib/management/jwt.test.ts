...
describe('Management JWT', () => {
  ...
  describe('impersonateStepup', () => {
    it('should send the correct request and receive correct response', async () => {
      ...
      const resp: SdkResponse<UpdateJWTResponse> = await management.jwt.impersonateStepup(
        'imp1',
        'imp2',
        true,
        { k1: 'v1' },
      ...
      expect(mockHttpClient.post).toHaveBeenCalledWith(apiPaths.jwt.impersonateStepup, {
        impersonatorId: 'imp1',
        loginId: 'imp2',
        validateConsent: true,
        customClaims: { k1: 'v1' },
